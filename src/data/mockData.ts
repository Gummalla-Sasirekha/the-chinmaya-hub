...
export const faculty: Faculty[] = [
  { id: 'f1', schoolId: 'stem', name: 'Dr. Praveen K M', phone: '+919876543210', email: 'praveen.km@cvv.ac.in', designation: 'Assistant Dean – Learning and Innovation | Associate Professor', roomNo: '204' },
