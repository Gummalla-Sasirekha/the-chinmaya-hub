    ...
    <main className="min-h-screen bg-[#F7F5F0] px-5 pb-10 pt-6 text-[#14213D] sm:px-6">
        ...
        <div className="flex gap-2 overflow-x-auto pb-1">
          ...
          {categories.map((category) => (
            ...
            <button
              ...
              className={`h-9 shrink-0 rounded-xl px-4 text-xs font-bold transition-all duration-200 ${
                filter === category
      ...
      <section className="mx-auto mt-4 max-w-2xl space-y-3">
        ...
        {visible.map((item) => (
          ...
          <article
            key={item.id}
            className="rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_2px_10px_rgba(20,33,61,0.04)] transition-all duration-200 hover:border-[#C9A24D]"
          >
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#14213D] text-[#C9A24D]">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.08em] text-[#C9A24D]">
                  {item.category}
                </span>
            ...
            {/* Title */}
            <h2 className="mt-4 text-[15px] font-bold leading-6 text-[#14213D]">
              {item.title}
            </h2>
        ...
        {!visible.length && (
          ...
          <div className="rounded-2xl border border-slate-200 bg-white px-6 py-12 text-center shadow-sm">
            ...
            <p className="mt-4 text-sm font-bold text-[#14213D]">
              No announcements
            </p>
...
function Info({
  ...
  return (
    <div className="flex items-start gap-2">
      ...
      <div className="mt-0.5 shrink-0 text-[#C9A24D]">
        {icon}
      </div>
      ...
      <div className="min-w-0">
        ...
        <p className="mt-0.5 break-words text-xs font-semibold leading-5 text-[#14213D]">
          {value}
        </p>
