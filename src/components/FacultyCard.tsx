      ...
      <div className="mt-4 flex gap-2 border-t border-slate-100 pt-3">
        ...
        >
          ...
          <svg
            ...
            className="h-3.5 w-3.5 text-[#C9A24D]"
          >
            <path d="M21 11.5a8.5 8.5 0 0 1-12.8 7.36L4 20l1.17-4.02A8.5 8.5 0 1 1 21 11.5Z" />
            <path d="M8.5 8.5c.3-.6.6-.6.9-.6h.3c.2 0 .4.1.5.4l.6 1.4c.1.2.1.4-.1.6l-.5.6c.5 1 1.3 1.8 2.3 2.3l.6-.5c.2-.2.4-.2.6-.1l1.4.6c.3.1.4.3.4.5v.3c0 .3 0 .6-.6.9-.4.2-1 .3-1.5.1-1.1-.3-2.3-1-3.4-2.1-1.1-1.1-1.8-2.3-2.1-3.4-.2-.5-.1-1.1.1-1.5Z" />
          </svg>
